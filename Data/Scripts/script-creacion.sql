...
ALTER TABLE TIPO_COMERCIO
ADD CONSTRAINT U_NOMBRE_TIPO UNIQUE (NOMBRE_TIPO);
...
ALTER TABLE REPARTIDOR_TELEFONOS
ADD CONSTRAINT FK_REPARTTELEFONOS_REPARTIDOR
FOREIGN KEY (USUARIO_REPART) REFERENCES REPARTIDOR(USUARIO_REPART);

ALTER TABLE REPARTIDOR_TELEFONOS
ADD CONSTRAINT U_REPARTIDOR_TEL UNIQUE (TELEFONO_REPART);